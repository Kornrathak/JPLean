 ...
 */
public class KatakanaScreen extends Screen {
    ...
    public KatakanaScreen(ScreenStack ss) {
        this.ss = ss;
    ...
    @Override
    public void update(int delta) { for (CustomButton item: pages) item.setStatus(1); }
}
